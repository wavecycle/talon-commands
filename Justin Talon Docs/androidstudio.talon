...
android device: user.idea("action DeviceAndSnapshotComboBox")
apple device: user.idea("action ExecutionTargets")
...
[go] declaration popup: user.idea("action QuickImplementations")
...
[android] (resume|restart): user.idea("action android.deploy.ApplyChanges")
